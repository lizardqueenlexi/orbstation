...
GLOBAL_LIST_INIT(special_roles, list(
	...
	ROLE_WIZARD_JOURNEYMAN = 0,  //ORBSTATION
	ROLE_CHANGELING_INFILTRATOR = 0,  //ORBSTATION
	ROLE_SMUGGLED_AGENT = 0,  //ORBSTATION
	ROLE_HERETIC_MIDROUND = 0,  //ORBSTATION
	ROLE_CONTRACT_KILLER = 0,  //ORBSTATION
	ROLE_CLOWN_LONE_OPERATIVE = 0,  //ORBSTATION
	ROLE_VOIDWALKER = 0,
