...
/proc/create_consistent_human_dna(mob/living/carbon/human/target)
	...
	// ORBSTATION
	target.dna.features["rat_snout"] = get_consistent_feature_entry(GLOB.rat_snouts_list)
	target.dna.features["rat_tail"]  = get_consistent_feature_entry(GLOB.rat_tails_list)
	target.dna.features["rat_ears"] = get_consistent_feature_entry(GLOB.rat_ears_list)
