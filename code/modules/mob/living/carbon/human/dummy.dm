...
/proc/create_consistent_human_dna(mob/living/carbon/human/target)
	...
	// ORBSTATION
	target.dna.features[FEATURE_RAT_SNOUT] = get_consistent_feature_entry(SSaccessories.rat_snouts_list)
	target.dna.features[FEATURE_RAT_TAIL]  = get_consistent_feature_entry(SSaccessories.rat_tails_list)
	target.dna.features[FEATURE_RAT_EARS] = get_consistent_feature_entry(SSaccessories.rat_ears_list)
	target.dna.features[FEATURE_MOTH_COLOR] = "#ffd98c"
