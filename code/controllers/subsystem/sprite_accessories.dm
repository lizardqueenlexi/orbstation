...
SUBSYSTEM_DEF(accessories) // just 'accessories' for brevity
	...
	//ORBSTATION ADDITION
	var/list/rat_snouts_list
	var/list/rat_tails_list
...
/datum/controller/subsystem/accessories/proc/setup_lists()
	...
	//ORBSTATION ADDITION
	rat_snouts_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/rat_snouts)[DEFAULT_SPRITE_LIST]
	rat_tails_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/tails/rat)[DEFAULT_SPRITE_LIST]
	rat_ears_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/rat_ears)[DEFAULT_SPRITE_LIST]
